          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-3/5 p-8 md:p-12 flex flex-col justify-center">
              ...
              <p className="text-gray-500 mb-8 leading-relaxed">
                A comprehensive 8-day program designed for agricultural
                professors and researchers to explore sustainable farming
                technologies, modern irrigation methods, and curriculum
                innovation.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-white border-2 border-[#0a2f1c] text-[#0a2f1c] hover:bg-[#0a2f1c] hover:text-white font-bold py-3.5 px-8 rounded-xl transition-all"
                >
                  <Download size={18} />
                  Download Brochure
                </a>
