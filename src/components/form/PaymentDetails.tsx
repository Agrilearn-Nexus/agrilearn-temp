...
const PaymentDetails = () => {
    ...
    const handleCopy = async () => {
        await navigator.clipboard.writeText("7814809913@psbbpay");
        setCopied(true);
            ...
            <div
                ...
                <div className="p-6 md:p-10">
                    ...
                    <div className="bg-blue-50 border border-blue-100 rounded-lg p-6 mb-8">
                        <div className="flex gap-3 items-start mb-4">
                            ...
                            <div>
                                <h4 className="font-bold text-blue-900">
                                    Certificate Type & Fee Details <span className="text-red-500">*</span>
                                </h4>
                        ...
                        <div
                            className="flex items-center gap-4 bg-white p-3 rounded w-full max-w-5xl justify-between mx-auto sm:mx-0">
                            <select
                                {...register("feeDetails", {
