...
const PaymentDetails = () => {
  ...
  // ];
  const feeStructure = [
    { category: "BSc", softCopy: "₹249" },
    { category: "MSc", softCopy: "₹349" },
    { category: "PhD Research Scholar", softCopy: "₹449" },
    { category: "Assistant Professor", softCopy: "₹599" },
    { category: "Associate Professor", softCopy: "₹599" },
    { category: "Scientist", softCopy: "₹599" },
  ];
  ...
  // ];
  const optionArray = [
    { category: "BSc", type: "Soft Copy", price: 249 },
    { category: "MSc", type: "Soft Copy", price: 349 },
    { category: "PhD", type: "Soft Copy", price: 449 },
    { category: "Assistant Professor", type: "Soft Copy", price: 599 },
    { category: "Associate Professor", type: "Soft Copy", price: 599 },
    { category: "Scientist", type: "Soft Copy", price: 599 },
  ];
  ...
  useEffect(() => {
    if (!watchedUpi) {
      setValue("upiId", upiOptions[0]);
    }
  }, [setValue, watchedUpi]);

  const selectedUpi = watchedUpi || upiOptions[0];
        ...
        <div className="p-6 md:p-10">
            ...
            <div className="relative w-full max-w-5xl mx-auto sm:mx-0 bg-white rounded-md border border-blue-200">
              ...
              >
                ...
                {optionArray.map((item, i) => (
                  ...
                  >
                    {getAbbreviation(item.category)} – {item.type} – ₹
                    {item.price}
                  </option>
                ))}
              </select>
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 sm:p-6 mb-8">
            ...
            <div className="mt-2 text-xs text-center sm:text-left text-blue-800/70">
              Having trouble?{" "}
              <span className="font-mono bg-blue-100 px-1 rounded select-all font-semibold">
                {selectedUpi}
              </span>{" "}
              (Long press to copy)
            </div>
