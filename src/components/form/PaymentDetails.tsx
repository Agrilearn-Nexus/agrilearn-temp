...
const PaymentDetails = () => {
    ...
    return (
        <div className="w-full flex justify-center p-4 md:p-8">
            <div
                className="w-full bg-white rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] border-t-8 border-[#3F7A5A] overflow-hidden">
                <div className="p-6 md:p-10">

                    {/* Header */}
                    <div className="flex items-center gap-4 mb-6">
                        <div
                            className="shrink-0 w-10 h-10 rounded-full bg-[#3F7A5A] text-white flex items-center justify-center font-bold text-xl font-serif">
                            2
                        </div>
                    ...
                    <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 sm:p-6 mb-8">
                        ...
                        <div
                            className="relative w-full max-w-5xl mx-auto sm:mx-0 bg-white rounded-md border border-blue-200">
                            <select
                    ...
                    <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 sm:p-6 mb-8">
                        ...
                        <div className="mt-2 text-xs text-center sm:text-left text-blue-800/70">
                            Having trouble? <span
                            className="font-mono bg-blue-100 px-1 rounded select-all font-semibold">{selectedUpi}</span> (Long
                            press to copy)
                        </div>
                    </div>
