    ...
    switch (status) {
      ...
      case "FAILED":
        return (
          <span
            title={reason}
            className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-bold bg-red-100 text-red-700 cursor-help"
          >
      ...
      case "SAVED":
        ...
        if (reason)
          return (
            <span
              title={reason}
              className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-bold bg-orange-100 text-orange-700 cursor-help"
            >
              ...
              >
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-linear-to-br from-green-100 to-green-200 text-green-700 flex items-center justify-center font-bold text-xs shadow-inner">
                      {getInitials(row.name)}
                    </div>
                    <div>
                      <div className="font-medium text-gray-900 group-hover:text-green-800 transition-colors">
                        {row.name}
                      </div>
                ...
                <td className="px-6 py-4">
                  <div
                    className="text-gray-700 font-medium truncate max-w-45"
                    title={row.institute}
                  >
                    {row.institute}
                  </div>
                ...
                <td className="px-6 py-4">
                  ...
                  >
                    {row.submissionReference?.type === "WHATSAPP_GROUP"
                      ? "WhatsApp"
                      : row.submissionReference?.type?.replace("_", " ") ||
                        "Unknown"}
                  </span>
                </td>
