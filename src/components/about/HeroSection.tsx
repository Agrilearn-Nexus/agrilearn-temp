  ...
  return (
    <section className="relative h-[60vh] min-h-125 flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/hero-agriculture.jpg" // Using your existing image
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#0a2f1c]/90 via-[#0a2f1c]/70 to-[#0a2f1c]/90" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white mb-6 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
          ...
          <br />
          <span className="text-[#E8BA30]">Growing Futures</span>
        </h1>
        ...
        <p className="max-w-2xl mx-auto text-lg md:text-xl text-gray-200 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
          Empowering agriculture students, professors, and farmers through innovative educational programs and hands-on learning experiences.
        </p>
      </div>
      
      {/* Decorative Wave */}
      <div className="absolute bottom-0 left-0 right-0 z-20">
        <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto text-gray-50">
