            ...
            <div className="container mx-auto px-4 max-w-6xl">
                <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
                    ...
                    <div className="lg:col-span-2 space-y-10">
                        ...
                        <div className="space-y-8">
                            {[
                                ...
                                >
                                    <div
                                        className="w-12 h-12 rounded-xl bg-[#0a2f1c]/5 flex items-center justify-center text-[#0a2f1c] group-hover:bg-[#E8BA30] group-hover:text-[#0a2f1c] transition-colors duration-300 shrink-0">
                                        {item.icon}
                                    </div>
                                    <div>
                    ...
                    <div className="lg:col-span-3">
                        <div
                            className="bg-white rounded-3xl p-8 md:p-10 shadow-xl shadow-[#0a2f1c]/5 border border-gray-100">
